...
const char* ssid     = "Awez";      // SSID of local network
const char* password = "abcdefgh";   // Password on network
String result;
String smoke ;
String motion ;
...
void ifttt() //Wifi connection and send all the data to IFTTT
{
  ...
  const char trigger[ ]     = "IOT_Motion_Sensor";                   //name of the trigger you would like to send to IFTTT
  const char APIKey[ ]      = "pxTmQ6ljMAQQPuEluzqyhwnF3Y3V3-ZGmAhtY_V1rzb";      //Your maker key for Webhooks on IFTTT
